// src/pages/CertificateCoursesPage.jsx
// ✅ Uses coursesData.jsx (level-based filtering)
// ✅ NOW: Course card image support added (uses c.image)
...
export default function CertificateCoursesPage() {
  ...
  const levelCourses = useMemo(
    () => courses.filter((c) => (c.level || "").toLowerCase() === "certificate"),
    []
  );
      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="mt-8 rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-3 text-xs text-slate-500">
            Showing <b>{filtered.length}</b> courses in <b>Certificate</b>
          </div>
        </div>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  <button
                    onClick={() =>
                      navigate(`/contact?course=${encodeURIComponent(c.title)}`)
                    }
